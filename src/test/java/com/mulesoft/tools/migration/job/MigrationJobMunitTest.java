...
public class MigrationJobMunitTest {
  ...
  public void setUp() throws Exception {
    // migrationJobBuilder.setDocuments(filePath1);

    // docRestoreFile1 = DocumentHelper.getDocument(MUNIT_SECTIONS_SAMPLE_PATH.toString());
    // docRestoreFile1 = DocumentHelper.getDocument(EXAMPLE_1_FILE_PATH);
    // docRestoreFile2 = DocumentHelper.getDocument(EXAMPLE_2_FILE_PATH);
    // docRestoreFile3 = DocumentHelper.getDocument(MUNIT_SECTIONS_SAMPLE_PATH);
    // docRestoreFile4 = DocumentHelper.getDocument(EXAMPLE_4_FILE_PATH);
