...
Mule Migration Assistant is distributed under the terms of the [Apache 2.0 License](https://github.com/mulesoft/mule-migration-assistant/blob/master/LICENSE.txt)
