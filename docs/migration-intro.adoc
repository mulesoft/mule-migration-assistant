...
is available as an open source project here on GitHub, in this https://github.com/mulesoft/mule-migration-assistant[mule-migration-assistant] repository.
...
* xref:user-docs/migration-prep.adoc[Preparing for a Migration to Mule 4]: Both migration scenarios require the same preparation.
...
* https://docs.mulesoft.com/mule-runtime/4.3/migration-process[Manual Migration Process] (external link)
