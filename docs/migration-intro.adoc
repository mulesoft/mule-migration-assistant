...
* xref:migration-prep.adoc[Preparing for a Migration to Mule 4]: Both migration scenarios require the same preparation.
* MMA migration process:
** xref:migration-tutorial.adoc[Mule Migration Assistant Tutorial]
** xref:migration-tool.adoc[Using the Mule Migration Assistant to Support Migration to Mule 4]
