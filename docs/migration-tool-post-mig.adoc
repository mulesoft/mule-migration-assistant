...
https://docs.mulesoft.com/connectors/scripting/scripting-module[Scripting module] (external link) and
...
https://docs.mulesoft.com/connectors/email/email-list#getting-data-from-emails[Getting Data from Emails] (external link)
and the section on _Attachments_
in https://docs.mulesoft.com/connectors/web-service/web-service-consumer-consume[Consume a Web Service - Mule 4] (external link).
...
+
https://docs.mulesoft.com/mule-runtime/4.1/dataweave-quickstart#med_large_payload[This example] (external link), starting at step 4, loads the
