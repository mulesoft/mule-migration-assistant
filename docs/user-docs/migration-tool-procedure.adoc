...
| `-muleVersion <arg>` | Required. The Mule version to which you are migrating: `4.3.0`. MMA supports migrations to Mule 4.2.0 and higher, but MuleSoft recommends that you migrate to a minimum of Mule 4.3.0 to take advantage of significant enhancements to performance and stability.
