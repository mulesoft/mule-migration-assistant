...
//+
//image::images/mmt-migrated-app-mvn-config-issue.png[Imported App][Imported App with Maven Configuration Issue]
+
. Proceed to <<step_4>>
...
<http:response statusCode="#[migration::HttpListener::httpListenerResponseSuccessStatusCode(vars)]">
  ...
  <!--        * https://beta.docs.stgx.mulesoft.com/beta-mule-migration-tool/mule-runtime/4.3/migration-tool-post-mig.html#outbound_properties-->
...
+
images:images/mmt-maven-repo-credentials.png[Configure Maven Repository Credentials]
+
