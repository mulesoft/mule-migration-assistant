...
Important::
MMA is subject to the terms and conditions described for https://www.mulesoft.com/legal/versioning-back-support-policy#community[Community] connectors.
...
MMA helps with such tasks, but it is not to be expected to
...
Important::
The Compatibility module is subject to conditions described for https://www.mulesoft.com/legal/versioning-back-support-policy#community[Community] connectors.
...
//WAS * xref:migration-api-gateways-proxies.adoc[HTTP Proxy apps]
* https://docs.mulesoft.com/mule-runtime/4.3/migration-api-gateways-proxies[HTTP Proxy apps] (external)

//WAS * xref:migration-api-gateways-policies.adoc[Custom Policies]
* https://docs.mulesoft.com/mule-runtime/4.3/migration-api-gateways-policies[Custom Policies] (external)
...
////
TODO: ARE WE GOING TO SUPPORT THESE IN THE FUTURE?
[[supported_future]]
