...
image::../assets/images/migrator-report.png[Mule Migration Assistant Report]
...
image::../assets/images/migrator-issue-found.png[Mule Migration Assistant Report - Issue Found]
