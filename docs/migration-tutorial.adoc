...
//NOT NEEDED FOR GA: ESTEBAN SAYS PROB NOT NEEDED BC COMPAT MODULES WILL BE AVAILABLE AT GA. TBD:
...
//NOT NEEDED FOR GA: If you do not know your credentials, contact your CSM. 
...
image::../assets/images/mmt-exchange.png[Exchange: Querying a MySQL Database]
...
+
//WORKAROUND FOR 0.5.1 (TODO: TBD IF VALID)
.Windows only:
...
+
image::../assets/images/mmt-migrated-app.png[Imported App]
+
...
//+
//image::../assets/images/mmt-migrated-app-mvn-config-issue.png[Imported App][Imported App with Maven Configuration Issue]
+
. Proceed to <<step_4>>
...
image::../assets/images/mmt-report.png[Mule Migration Assistant Report]
...
image::../assets/images/mmt-resulting-flow.png[Flow: Database To JSON]
...
+
image::../assets/images/mmt-outbound-properties-to-var.png[Outbound Properties to var]
+
...
+
image::../assets/images/mmt-db-open-db-config.png[Database Configuration: Opening Database Config Window]
+
...
+
image::../assets/images/mmt-db-mysql.png[Database Configuration: MySQL Connection]
+
...
+
image::../assets/images/mmt-db-add-recommended-lib.png[Database Configuration: Add Recommended Libraries]
+
...
setting, for example:
+
image::../assets/images/mmt-db-set-properties.png[Database Configuration: Set Properties]
+
...
----
+
image::../assets/images/mmt-db-query.png[Perform A Query in MySQL]
+
...
+
image::../assets/images/mmt-dataweave.png[Transform Message]
+
...
////
REMOVES MAVEN CONFIGURATION, NOT NEEDED FOR GA 1.0.0
== Maven Configuration
...
// TODO: DETERMINE IF THIS IS NEEDED, SEE NOTE ABOVE RE ESTEBAN'S COMMENTS
[[step_maven]]
...
+
images:../assets/images/mmt-maven-repo-credentials.png[Configure Maven Repository Credentials]
+
...
<repositories>
  <repository>
   ...
   <!-- any other repositories above or below -->
</repositories>
----
+
. Restart Studio.
...
////
////
REMOVES MAVEN INSTALLATION STEPS. NOT NEEDED FOR GA. 
[[maven_install]]
...
`mvn --version`
+
If you receive a response such as `-bash: mvn: command not found` or if you version is lower than version 3.3.9, download the *Link* to the latest version of Maven at http://maven.apache.org/download.cgi[Maven `zip` file] (external link), and install Maven by following the instructions on the Maven site: http://maven.apache.org/install.html[Maven (version 3.3.9 or later)]  (external link)
+
