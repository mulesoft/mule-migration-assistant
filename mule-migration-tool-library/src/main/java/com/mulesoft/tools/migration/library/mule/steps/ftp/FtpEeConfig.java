 ...
 * @since 1.0.0
 */
public class FtpEeConfig extends AbstractApplicationModelMigrationStep
  ...
  public void execute(Element object, MigrationReport report) throws RuntimeException {
    ...
    // "'serialiseObjects' is not needed in Mule 4 File Connector, you may process the payload with DataWeave directly without the
    // need to convert it to a Java object.",
    ...
    // report.report(WARN, object, object,
    // "'workDirectory' is not needed in Mule 4 File Connector. The source file is locked, so there is no need to move it to a
    // temporary location.",
    ...
    // report.report(WARN, object, object,
    // "'workFileNamePattern' is not needed in Mule 4 File Connector. The source file is locked, so there is no need to move it to
