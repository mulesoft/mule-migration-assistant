 ...
 */
package com.obi.tools.migration.library.smartgate.steps.gateway;
...
public class ApiTagMigrationStep extends GatewayMigrationStep {
  ...
  public ApiTagMigrationStep() {
    super(GatewayNamespaces.API_PLATFORM_GW_MULE_3_NAMESPACE, API_TAG_NAME);
  }
  ...
  public void execute(Element element, MigrationReport migrationReport) throws RuntimeException {
    migrateRootElement(element, API_PLATFORM_GW_MULE_3_NAMESPACE, API_GW_MULE_4_NAMESPACE,
                       ...
                       API_GATEWAY_XSI_SCHEMA_LOCATION_URI_MULE4_XSD,
                       API_GATEWAY_XSI_SCHEMA_LOCATION_URI_MULE3,
                       API_GATEWAY_XSI_SCHEMA_LOCATION_URI_MULE4);
    element.setName(AUTODISCOVERY_TAG_NAME);
    element.setNamespace(GatewayNamespaces.API_GW_MULE_4_NAMESPACE);
    final Attribute attribute = element.getAttribute(VERSION);
    if (attribute != null && attribute.getValue() != null) {
      element.setAttribute(new Attribute(API_ID, attribute.getValue()));
    } else {
