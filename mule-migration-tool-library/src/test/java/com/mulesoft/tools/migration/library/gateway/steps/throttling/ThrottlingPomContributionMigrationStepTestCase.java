...
public class ThrottlingPomContributionMigrationStepTestCase {


  //  @Test
  //  public void pomContributionTest() {
  //    PomModel pm = new PomModel();
  //    ThrottlingPomContributionMigrationStep step = new ThrottlingPomContributionMigrationStep();
  //    step.execute(pm, mock(MigrationReport.class));
  //    assertThat(pm.getDependencies().size(), is(2));
  //    Dependency httpTransformDependency = pm.getDependencies().get(0);
